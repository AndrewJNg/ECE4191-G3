...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=25000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=Motor_1_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Motor_1_PWM, CY_INSTANCE_SHORT_NAME=Motor_1_PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Motor_1_PWM, )
module PWM_v3_30_0 (
    capture,
    clock,
    cmp_sel,
...
module UART_v2_50_7 (
	...
	cy_clock_v1_0
		#(.id("a0eed4dd-77d0-40fa-a44d-1fea2286cd48/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    PWM_v3_30_0 Motor_1_PWM (
        ...
        .tc(Net_55),
        .trigger(1'b0));
    defparam Motor_1_PWM.Resolution = 16;

    PWM_v3_30_1 Motor_2_PWM (
        .capture(1'b0),
        .clock(Net_44),
        .cmp_sel(1'b0),
        .enable(1'b1),
        ...
        .tc(Net_83),
        .trigger(1'b0));
    defparam Motor_2_PWM.Resolution = 16;
	...
	cy_clock_v1_0
		#(.id("7560cd1e-8f5f-4832-8df6-3600caa19a03"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Motor_1_EN_net;
	wire [0:0] tmpFB_0__Motor_1_EN_net;
	wire [0:0] tmpIO_0__Motor_1_EN_net;
	wire [0:0] tmpINTERRUPT_0__Motor_1_EN_net;
	electrical [0:0] tmpSIOVREF__Motor_1_EN_net;
	...
	cy_psoc3_pins_v1_10
		...
		Motor_1_EN
		 (.oe(tmpOE__Motor_1_EN_net),
		  .y({Net_51}),
		  .fb({tmpFB_0__Motor_1_EN_net[0:0]}),
		  .io({tmpIO_0__Motor_1_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_1_EN_net),
		  .interrupt({tmpINTERRUPT_0__Motor_1_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_1_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("9b02a4b7-78c1-4650-b552-bbd06a5f3e12"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Motor_1_IN1_net;
	wire [0:0] tmpFB_0__Motor_1_IN1_net;
	wire [0:0] tmpIO_0__Motor_1_IN1_net;
	wire [0:0] tmpINTERRUPT_0__Motor_1_IN1_net;
	electrical [0:0] tmpSIOVREF__Motor_1_IN1_net;

	cy_psoc3_pins_v1_10
		#(.id("bb273718-b651-4d5a-9c7a-831289ec6930"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_1_IN1
		 (.oe(tmpOE__Motor_1_IN1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor_1_IN1_net[0:0]}),
		  .io({tmpIO_0__Motor_1_IN1_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_1_IN1_net),
		  .interrupt({tmpINTERRUPT_0__Motor_1_IN1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_1_IN1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_1_IN2_net;
	wire [0:0] tmpFB_0__Motor_1_IN2_net;
	wire [0:0] tmpIO_0__Motor_1_IN2_net;
	wire [0:0] tmpINTERRUPT_0__Motor_1_IN2_net;
	electrical [0:0] tmpSIOVREF__Motor_1_IN2_net;

	cy_psoc3_pins_v1_10
		#(.id("b8dd55db-551a-4453-9bb2-5d4f151561e4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_1_IN2
		 (.oe(tmpOE__Motor_1_IN2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor_1_IN2_net[0:0]}),
		  .io({tmpIO_0__Motor_1_IN2_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_1_IN2_net),
		  .interrupt({tmpINTERRUPT_0__Motor_1_IN2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_1_IN2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_2_IN1_net;
	wire [0:0] tmpFB_0__Motor_2_IN1_net;
	wire [0:0] tmpIO_0__Motor_2_IN1_net;
	wire [0:0] tmpINTERRUPT_0__Motor_2_IN1_net;
	electrical [0:0] tmpSIOVREF__Motor_2_IN1_net;

	cy_psoc3_pins_v1_10
		#(.id("a9d33356-e5ba-4670-a838-9157f2330d07"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_2_IN1
		 (.oe(tmpOE__Motor_2_IN1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor_2_IN1_net[0:0]}),
		  .io({tmpIO_0__Motor_2_IN1_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_2_IN1_net),
		  .interrupt({tmpINTERRUPT_0__Motor_2_IN1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_2_IN1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_2_IN2_net;
	wire [0:0] tmpFB_0__Motor_2_IN2_net;
	wire [0:0] tmpIO_0__Motor_2_IN2_net;
	wire [0:0] tmpINTERRUPT_0__Motor_2_IN2_net;
	electrical [0:0] tmpSIOVREF__Motor_2_IN2_net;

	cy_psoc3_pins_v1_10
		#(.id("d5979e17-ed0d-48d6-9203-49ecf202bb70"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_2_IN2
		 (.oe(tmpOE__Motor_2_IN2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor_2_IN2_net[0:0]}),
		  .io({tmpIO_0__Motor_2_IN2_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_2_IN2_net),
		  .interrupt({tmpINTERRUPT_0__Motor_2_IN2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_2_IN2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_1_PhaseA_net;
	wire [0:0] tmpIO_0__Motor_1_PhaseA_net;
	wire [0:0] tmpINTERRUPT_0__Motor_1_PhaseA_net;
	electrical [0:0] tmpSIOVREF__Motor_1_PhaseA_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_1_PhaseA
		 (.oe(tmpOE__Motor_1_PhaseA_net),
		  .y({1'b0}),
		  .fb({Net_85}),
		  .io({tmpIO_0__Motor_1_PhaseA_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_1_PhaseA_net),
		  .interrupt({tmpINTERRUPT_0__Motor_1_PhaseA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_1_PhaseA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_1_PhaseB_net;
	wire [0:0] tmpIO_0__Motor_1_PhaseB_net;
	wire [0:0] tmpINTERRUPT_0__Motor_1_PhaseB_net;
	electrical [0:0] tmpSIOVREF__Motor_1_PhaseB_net;

	cy_psoc3_pins_v1_10
		#(.id("d5a38569-0be0-4f11-a0c0-10d7b8e37a0d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_1_PhaseB
		 (.oe(tmpOE__Motor_1_PhaseB_net),
		  .y({1'b0}),
		  .fb({Net_86}),
		  .io({tmpIO_0__Motor_1_PhaseB_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_1_PhaseB_net),
		  .interrupt({tmpINTERRUPT_0__Motor_1_PhaseB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_1_PhaseB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_2_PhaseA_net;
	wire [0:0] tmpIO_0__Motor_2_PhaseA_net;
	wire [0:0] tmpINTERRUPT_0__Motor_2_PhaseA_net;
	electrical [0:0] tmpSIOVREF__Motor_2_PhaseA_net;

	cy_psoc3_pins_v1_10
		#(.id("3414bc53-57dc-4ba7-b006-463f6ddc4e56"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_2_PhaseA
		 (.oe(tmpOE__Motor_2_PhaseA_net),
		  .y({1'b0}),
		  .fb({Net_93}),
		  .io({tmpIO_0__Motor_2_PhaseA_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_2_PhaseA_net),
		  .interrupt({tmpINTERRUPT_0__Motor_2_PhaseA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_2_PhaseA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_2_PhaseB_net;
	wire [0:0] tmpIO_0__Motor_2_PhaseB_net;
	wire [0:0] tmpINTERRUPT_0__Motor_2_PhaseB_net;
	electrical [0:0] tmpSIOVREF__Motor_2_PhaseB_net;

	cy_psoc3_pins_v1_10
		#(.id("c6af5633-8cdd-466d-b0ab-814402f689f1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_2_PhaseB
		 (.oe(tmpOE__Motor_2_PhaseB_net),
		  .y({1'b0}),
		  .fb({Net_94}),
		  .io({tmpIO_0__Motor_2_PhaseB_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_2_PhaseB_net),
		  .interrupt({tmpINTERRUPT_0__Motor_2_PhaseB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_2_PhaseB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("3649dcfb-3a96-4aa3-833e-8f022a21255a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8acfb654-e322-4bfb-913b-64780f5562a1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    Timer_v2_80_8 GlobalClock (
        ...
        .tc(Net_230),
        .trigger(1'b1));
    defparam GlobalClock.CaptureCount = 2;
    defparam GlobalClock.CaptureCounterEnabled = 0;
    defparam GlobalClock.DeviceFamily = "PSoC5";
    defparam GlobalClock.InterruptOnCapture = 0;
    defparam GlobalClock.InterruptOnTC = 0;
    defparam GlobalClock.Resolution = 32;
    defparam GlobalClock.SiliconRevision = "0";
