...
{
    uint8 staticBits = (Motor_2_EN_DR & (uint8)(~Motor_2_EN_MASK));
    Motor_2_EN_DR = staticBits | ((uint8)(value << Motor_2_EN_SHIFT) & Motor_2_EN_MASK);
}
...
{
	CyPins_SetPinDriveMode(Motor_2_EN_0, mode);
}
...
{
    return (Motor_2_EN_PS & Motor_2_EN_MASK) >> Motor_2_EN_SHIFT;
}
...
{
    return (Motor_2_EN_DR & Motor_2_EN_MASK) >> Motor_2_EN_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Motor_2_EN_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Motor_2_EN_0_INTR) != 0u) 
		{ 
			 Motor_2_EN_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Motor_2_EN_INTSTAT & Motor_2_EN_MASK) >> Motor_2_EN_SHIFT;
    }
