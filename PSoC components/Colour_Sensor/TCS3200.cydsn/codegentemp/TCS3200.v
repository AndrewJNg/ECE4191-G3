...
`ifdef WARP
`define CY_BLK_DIR "D:\Monash_Apps\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0"
`include "D:\Monash_Apps\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0\B_Counter_v3_0.v"
`else
`define CY_BLK_DIR "D:\Monash_Apps\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0"
`include "D:\Monash_Apps\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0\B_Counter_v3_0.v"
`endif

// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=2294967294, CONTROL3=0, ControlRegRemoved=1, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967294, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=true, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Pulse_counter, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Pulse_counter, CY_INSTANCE_SHORT_NAME=Pulse_counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Pulse_counter, )
...
`ifdef WARP
`define CY_BLK_DIR "D:\Monash_Apps\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Count7_v1_0"
`include "D:\Monash_Apps\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Count7_v1_0\Count7_v1_0.v"
`else
`define CY_BLK_DIR "D:\Monash_Apps\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Count7_v1_0"
`include "D:\Monash_Apps\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Count7_v1_0\Count7_v1_0.v"
`endif
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=3000, CompareValue2=3000, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=65535, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=ServoBlock2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ServoBlock2, CY_INSTANCE_SHORT_NAME=ServoBlock2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ServoBlock2, )
module PWM_v3_30_2 (
    capture,
    clock,
    cmp_sel,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=3000, CompareValue2=3000, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=40000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=ServoBlock1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ServoBlock1, CY_INSTANCE_SHORT_NAME=ServoBlock1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ServoBlock1, )
module PWM_v3_30_3 (
    capture,
    clock,
    cmp_sel,
...
module top ;
    ...
    Counter_v3_0_0 Pulse_counter (
        ...
        .up_ndown(1'b1),
        .upCnt(1'b0));
    defparam Pulse_counter.CaptureMode = 0;
    defparam Pulse_counter.ClockMode = 0;
    defparam Pulse_counter.CompareMode = 1;
    defparam Pulse_counter.CompareStatusEdgeSense = 1;
    defparam Pulse_counter.EnableMode = 1;
    defparam Pulse_counter.ReloadOnCapture = 1;
    defparam Pulse_counter.ReloadOnCompare = 0;
    defparam Pulse_counter.ReloadOnOverUnder = 1;
    defparam Pulse_counter.ReloadOnReset = 1;
    defparam Pulse_counter.Resolution = 32;
    defparam Pulse_counter.RunMode = 0;
    defparam Pulse_counter.UseInterrupt = 1;
	...
	cy_clock_v1_0
		#(.id("fb0089de-7c5d-488a-9301-2a04a0166763"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7f44b8b7-353d-4e25-8d45-bc2efa9d42d4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_1 UART_1 (
        ...
        .rx_clk(Net_900),
        .rx_data(Net_901),
        .rx_interrupt(Net_902),
        .tx(Net_903),
        .tx_clk(Net_904),
        .tx_data(Net_905),
        .tx_en(Net_906),
        .tx_interrupt(Net_907));
	...
	cy_clock_v1_0
		#(.id("0f4f7fe5-6b61-4afa-9daa-1a6927eeec36"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__ColourSensor_S0_net;
	wire [0:0] tmpFB_0__ColourSensor_S0_net;
	wire [0:0] tmpIO_0__ColourSensor_S0_net;
	wire [0:0] tmpINTERRUPT_0__ColourSensor_S0_net;
	electrical [0:0] tmpSIOVREF__ColourSensor_S0_net;

	cy_psoc3_pins_v1_10
		#(.id("2e46a1e8-26fa-41b9-abe3-c14fad475597"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ColourSensor_S0
		 (.oe(tmpOE__ColourSensor_S0_net),
		  .y({Net_550}),
		  .fb({tmpFB_0__ColourSensor_S0_net[0:0]}),
		  .io({tmpIO_0__ColourSensor_S0_net[0:0]}),
		  .siovref(tmpSIOVREF__ColourSensor_S0_net),
		  .interrupt({tmpINTERRUPT_0__ColourSensor_S0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ColourSensor_S0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ColourSensor_S1_net;
	wire [0:0] tmpFB_0__ColourSensor_S1_net;
	wire [0:0] tmpIO_0__ColourSensor_S1_net;
	wire [0:0] tmpINTERRUPT_0__ColourSensor_S1_net;
	electrical [0:0] tmpSIOVREF__ColourSensor_S1_net;

	cy_psoc3_pins_v1_10
		#(.id("6a39a431-d523-4ab0-987b-30462397b4c4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ColourSensor_S1
		 (.oe(tmpOE__ColourSensor_S1_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__ColourSensor_S1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ColourSensor_S1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ColourSensor_S2_net;
	wire [0:0] tmpFB_0__ColourSensor_S2_net;
	wire [0:0] tmpIO_0__ColourSensor_S2_net;
	wire [0:0] tmpINTERRUPT_0__ColourSensor_S2_net;
	electrical [0:0] tmpSIOVREF__ColourSensor_S2_net;

	cy_psoc3_pins_v1_10
		#(.id("5bd7f50c-ecd0-4f22-baac-553e5b0bacc9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ColourSensor_S2
		 (.oe(tmpOE__ColourSensor_S2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ColourSensor_S2_net[0:0]}),
		  .io({tmpIO_0__ColourSensor_S2_net[0:0]}),
		  .siovref(tmpSIOVREF__ColourSensor_S2_net),
		  .interrupt({tmpINTERRUPT_0__ColourSensor_S2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ColourSensor_S2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ColourSensor_S3_net;
	wire [0:0] tmpFB_0__ColourSensor_S3_net;
	wire [0:0] tmpIO_0__ColourSensor_S3_net;
	wire [0:0] tmpINTERRUPT_0__ColourSensor_S3_net;
	electrical [0:0] tmpSIOVREF__ColourSensor_S3_net;

	cy_psoc3_pins_v1_10
		#(.id("68d0f6c6-06e4-43ba-8ed7-b07c8f39c0f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ColourSensor_S3
		 (.oe(tmpOE__ColourSensor_S3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ColourSensor_S3_net[0:0]}),
		  .io({tmpIO_0__ColourSensor_S3_net[0:0]}),
		  .siovref(tmpSIOVREF__ColourSensor_S3_net),
		  .interrupt({tmpINTERRUPT_0__ColourSensor_S3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ColourSensor_S3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ColourSensor_OUT_net;
	wire [0:0] tmpIO_0__ColourSensor_OUT_net;
	wire [0:0] tmpINTERRUPT_0__ColourSensor_OUT_net;
	electrical [0:0] tmpSIOVREF__ColourSensor_OUT_net;

	cy_psoc3_pins_v1_10
		#(.id("6d0a381f-9397-4e59-8ef3-9ad3feb7a5fa"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ColourSensor_OUT
		 (.oe(tmpOE__ColourSensor_OUT_net),
		  .y({1'b0}),
		  .fb({Net_581}),
		  .io({tmpIO_0__ColourSensor_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__ColourSensor_OUT_net),
		  .interrupt({tmpINTERRUPT_0__ColourSensor_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
    ...
    PWM_v3_30_2 ServoBlock2 (
        ...
        .tc(Net_1003),
        .trigger(1'b0));
    defparam ServoBlock2.Resolution = 16;
	...
	cy_psoc3_pins_v1_10
		#(.id("a2a64338-833b-4749-8a64-397bf99e4f37"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("07859c99-a36a-41c0-a546-713bd2f4113e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_3 ServoBlock1 (
        ...
        .tc(Net_1013),
        .trigger(1'b0));
    defparam ServoBlock1.Resolution = 16;

    assign Net_795 = 1'h0;


	cy_clock_v1_0
		#(.id("d22ffb09-0ca7-4949-ac3b-152cfc3eb9c8"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
