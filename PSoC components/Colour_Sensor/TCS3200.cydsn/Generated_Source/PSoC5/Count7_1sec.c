...
#include "Count7_1sec.h"

uint8 Count7_1sec_initVar = 0u;


/*******************************************************************************
* Function Name: Count7_1sec_Init
********************************************************************************
*
* Summary:
...
void Count7_1sec_Init(void) 
{
    ...
    Count7_1sec_PERIOD_REG = Count7_1sec_INITIAL_PERIOD;
}


/*******************************************************************************
* Function Name: Count7_1sec_Enable
********************************************************************************
*
* Summary:
...
void Count7_1sec_Enable(void) 
{
    ...
    */
    Count7_1sec_AUX_CONTROL_REG |= Count7_1sec_COUNTER_START;
...
/*******************************************************************************
* Function Name: Count7_1sec_Start
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  Count7_1sec_initVar - global variable.
*
* Return:
*  None.
*
...
void Count7_1sec_Start(void) 
{
    ...
    if(Count7_1sec_initVar == 0u)
    {
        Count7_1sec_Init();
        Count7_1sec_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: Count7_1sec_Stop
********************************************************************************
*
* Summary:
...
void Count7_1sec_Stop(void) 
{
    ...
    Count7_1sec_AUX_CONTROL_REG &= (uint8) ~((uint8) Count7_1sec_COUNTER_START);
...
/*******************************************************************************
* Function Name: Count7_1sec_WriteCounter
********************************************************************************
*
* Summary:
...
{
    Count7_1sec_COUNT_REG = (count & Count7_1sec_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: Count7_1sec_ReadCounter
********************************************************************************
*
* Summary:
...
{
    return(Count7_1sec_COUNT_REG & Count7_1sec_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: Count7_1sec_WritePeriod
********************************************************************************
*
* Summary:
...
{
    Count7_1sec_PERIOD_REG = period;
}


/*******************************************************************************
* Function Name: Count7_1sec_ReadPeriod
********************************************************************************
*
* Summary:
