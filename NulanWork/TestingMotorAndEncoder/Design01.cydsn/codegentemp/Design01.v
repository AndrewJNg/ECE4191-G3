...
module top ;
	...
	wire [0:0] tmpFB_0__Motor_IN_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Motor_IN_1
		 (.oe(tmpOE__Motor_IN_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor_IN_1_net[0:0]}),
	...
	cy_psoc3_pins_v1_10
		...
		Motor_IN_2
		 (.oe(tmpOE__Motor_IN_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor_IN_2_net[0:0]}),
	...
	cy_psoc3_pins_v1_10
		#(.id("fd38672f-a7cf-4b8a-86b5-208cf8d61fb8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Motor_Phase_A_net;
	wire [0:0] tmpIO_0__Motor_Phase_A_net;
	wire [0:0] tmpINTERRUPT_0__Motor_Phase_A_net;
	electrical [0:0] tmpSIOVREF__Motor_Phase_A_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_Phase_A
		 (.oe(tmpOE__Motor_Phase_A_net),
		  .y({1'b0}),
		  .fb({Net_59}),
		  .io({tmpIO_0__Motor_Phase_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_Phase_A_net),
		  .interrupt({tmpINTERRUPT_0__Motor_Phase_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_Phase_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_Phase_B_net;
	wire [0:0] tmpIO_0__Motor_Phase_B_net;
	wire [0:0] tmpINTERRUPT_0__Motor_Phase_B_net;
	electrical [0:0] tmpSIOVREF__Motor_Phase_B_net;

	cy_psoc3_pins_v1_10
		#(.id("68360933-516a-4332-b201-d8f01a215fa8"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_Phase_B
		 (.oe(tmpOE__Motor_Phase_B_net),
		  .y({1'b0}),
		  .fb({Net_60}),
		  .io({tmpIO_0__Motor_Phase_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_Phase_B_net),
		  .interrupt({tmpINTERRUPT_0__Motor_Phase_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_Phase_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("cafdcf9f-67b2-469d-9c1c-3e12deec7003"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
