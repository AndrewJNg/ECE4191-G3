...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=12700, CompareValue2=1200, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=25000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_1, CY_INSTANCE_SHORT_NAME=PWM_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_1, )
module PWM_v3_30_0 (
    capture,
    clock,
    cmp_sel,
...
module top ;
	...
	cy_clock_v1_0
		#(.id("04ae1e73-dce4-437a-ad94-e21701096d37"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Motor_OUT1_net;
	wire [0:0] tmpFB_0__Motor_OUT1_net;
	wire [0:0] tmpIO_0__Motor_OUT1_net;
	wire [0:0] tmpINTERRUPT_0__Motor_OUT1_net;
	electrical [0:0] tmpSIOVREF__Motor_OUT1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Motor_OUT1
		 (.oe(tmpOE__Motor_OUT1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor_OUT1_net[0:0]}),
		  .io({tmpIO_0__Motor_OUT1_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_OUT1_net),
		  .interrupt({tmpINTERRUPT_0__Motor_OUT1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_OUT1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_OUT2_net;
	wire [0:0] tmpFB_0__Motor_OUT2_net;
	wire [0:0] tmpIO_0__Motor_OUT2_net;
	wire [0:0] tmpINTERRUPT_0__Motor_OUT2_net;
	electrical [0:0] tmpSIOVREF__Motor_OUT2_net;

	cy_psoc3_pins_v1_10
		#(.id("15d1cba3-c87d-46f9-99c6-ff8327e23ddd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_OUT2
		 (.oe(tmpOE__Motor_OUT2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor_OUT2_net[0:0]}),
		  .io({tmpIO_0__Motor_OUT2_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_OUT2_net),
		  .interrupt({tmpINTERRUPT_0__Motor_OUT2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_OUT2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("47ba81ec-9b3d-45f8-984b-a60125e2a0c4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Motor_IN_1_net;
	wire [0:0] tmpIO_0__Motor_IN_1_net;
	wire [0:0] tmpINTERRUPT_0__Motor_IN_1_net;
	electrical [0:0] tmpSIOVREF__Motor_IN_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_IN_1
		 (.oe(tmpOE__Motor_IN_1_net),
		  .y({1'b0}),
		  .fb({Net_37}),
		  .io({tmpIO_0__Motor_IN_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_IN_1_net),
		  .interrupt({tmpINTERRUPT_0__Motor_IN_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_IN_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_IN_2_net;
	wire [0:0] tmpIO_0__Motor_IN_2_net;
	wire [0:0] tmpINTERRUPT_0__Motor_IN_2_net;
	electrical [0:0] tmpSIOVREF__Motor_IN_2_net;

	cy_psoc3_pins_v1_10
		#(.id("0a28d807-1032-4e9a-854f-0543046d3fac"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_IN_2
		 (.oe(tmpOE__Motor_IN_2_net),
		  .y({1'b0}),
		  .fb({Net_38}),
		  .io({tmpIO_0__Motor_IN_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_IN_2_net),
		  .interrupt({tmpINTERRUPT_0__Motor_IN_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_IN_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
